...
import com.baorun.handbook.a88.network.Api
import com.baorun.handbook.a88.network.BaseResponse
import com.baorun.handbook.a88.network.FeedbackDataResponse
import com.baorun.handbook.a88.network.RetrofitManager
import com.baorun.handbook.a88.network.request.ClientAddBody
import com.baorun.handbook.a88.network.request.DeviceId
import com.baorun.handbook.a88.network.request.FeedbackDeleteBody
import com.baorun.handbook.a88.utils.getDataJson
...
interface DataRepositorySource {
    ...
    fun getRedIndicatorHotspotList(): HotSpotWrapper {
        return HotSpotWrapper(
            1054, 491, listOf(
                Hotspots( "1", Hotspots.Point(57, 261), "r_cdxt",),
                ...
                Hotspots("12", Hotspots.Point(57, 303),"r_xtgz"),
